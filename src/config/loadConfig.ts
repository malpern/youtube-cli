...
function normalizeConfig(parsed: ReturnType<typeof runConfigSchema.parse>): RunConfig {
  return {
    ...
    browserWindowWidth: parsed.browserWindowWidth,
    browserWindowHeight: parsed.browserWindowHeight,
    browserWindowPositionX: parsed.browserWindowPositionX,
    browserWindowPositionY: parsed.browserWindowPositionY,
    browserViewportWidth: parsed.browserViewportWidth,
    browserViewportHeight: parsed.browserViewportHeight,
